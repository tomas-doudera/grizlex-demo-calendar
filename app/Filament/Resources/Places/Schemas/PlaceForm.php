                ...
                Tabs::make('Tabs')
                    ->tabs([
                        Tab::make(__('filament/places.tabs.general'))
                            ...
                            ->schema([
                                Section::make(__('filament/places.sections.basic_info'))
                                    ->columns(2)
                                    ->schema([
                        ...
                        Tab::make(__('filament/places.tabs.address'))
                            ->icon(Heroicon::OutlinedMapPin)
                            ->schema([
                                Section::make(__('filament/places.sections.address'))
                                    ->columns(2)
                                    ->schema([
                                ...
                                Section::make(__('filament/places.sections.location'))
                                    ->columns(2)
                                    ->schema([
                        ...
                        Tab::make(__('filament/places.tabs.preferences'))
                            ->icon(Heroicon::OutlinedAdjustmentsHorizontal)
                            ->schema([
                                Section::make(__('filament/places.sections.preferences'))
                                    ->columns(2)
                                    ->schema([
                                        TextInput::make('sort_order')
                                            ->label(__('filament/places.fields.sort_order'))
                                            ->numeric()
                                            ->default(0)
                                            ->required(),
                                    ]),
