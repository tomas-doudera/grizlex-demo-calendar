...
namespace App\Domain\Shared\Filament\Resources\Companies\Schemas;
                                ...
                                Section::make(__('filament/companies.sections.details'))
                                    ...
                                    ->schema([
                                        TextInput::make('title')
                                            ->label(__('filament/companies.fields.company_name'))
                                            ->required()
                                            ->maxLength(255),
                                ...
                                Section::make(__('filament/companies.sections.settings'))
                                    ->schema([
                                        Toggle::make('is_active')
                                            ->label(__('filament/companies.fields.active'))
                                            ->default(true),
